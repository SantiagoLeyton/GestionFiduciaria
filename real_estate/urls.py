...
urlpatterns = [
    ...
    path("grouping-types/<int:pk>/delete/", GroupingTypeDeleteView.as_view(), name="grouping_type_delete"),
    ...
    path("structural-groups/<int:pk>/delete/", StructuralGroupDeleteView.as_view(), name="structural_group_delete"),
    ...
    path("property-units/<int:pk>/delete/", PropertyUnitDeleteView.as_view(), name="property_unit_delete"),
